            ...
            <div class="overlay-wrapper" style="margin-top: 15px;">
                ...
                <div class="col-12 content-option" style="cursor:pointer;">
                    <div id="div-ocupar-mesa" class="info-box bg-gradient-info btn-opcoes-mesa">
                        ...
                        <span class="info-box-text">Ocupar</span>
                    </div>

                    <div id="div-vincular-mesa" class="info-box bg-gradient-info btn-opcoes-mesa" onclick="acaoMesa('2', '3')">
                        <i class="fa fa-link" aria-hidden="true"></i>
                        <span class="info-box-text">Vincular</span>
                        <span class="info-box-text">mesas</span>

                    </div>

                    <div id="div-fechar-mesa" class="info-box bg-gradient-info btn-opcoes-mesa" onclick="acaoMesa('2', '3')">
